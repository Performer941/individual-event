    ...
    var h = {
            ...
            update: h, translate: v, transition: f, slide: g, loop: b, grabCursor: w, manipulation: y, events: {
                ...
                loadImage: function (e, t, a, i, r, n) {
                    ...
                    var e = this;
                    e.imagesToLoad = e.$el.find("images");
        ...
        D = {name: "browser", proto: {browser: m}, static: {browser: m}}, O = {
            ...
            getDistanceBetweenTouches: function (e) {
                ...
                if (r.$slideEl || (r.$slideEl = a.clickedSlide ? e(a.clickedSlide) : a.slides.eq(a.activeIndex), r.$imageEl = r.$slideEl.find("images, svg, canvas"), r.$imageWrapEl = r.$imageEl.parent("." + s.containerClass)), r.$imageEl && 0 !== r.$imageEl.length) {
...
!function (o) {
    ...
    o.fn.toTop = function (t) {
        var e = this, i = o(window), s = o("html, body"),
